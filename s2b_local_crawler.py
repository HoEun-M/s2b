...
""".strip()
    css += """
.subregion-cell{min-width:90px;white-space:nowrap;color:#263442}tbody td:nth-child(8){font-weight:600;white-space:nowrap}tbody td:nth-child(9){font-size:12px;color:#5c6670;white-space:nowrap}.purchase-clear{height:28px;border:1px solid #245a92;border-radius:14px;background:#fff;color:#245a92;font-family:inherit;font-size:12px;padding:0 10px;cursor:pointer}.purchase-clear.active{background:#245a92;color:#fff}
""".strip()
...
function dashboardFilterLabel(filter){if(!filter){return '';}var names={vendor:'업체',month:'월',school:'학교급',region:'시도',subregion:'세부지역'};var prefix=names[filter.type]||'대시보드';return prefix+': '+filter.value+(filter.type==='subregion'&&filter.region?' ('+filter.region+')':'');}
...
""".strip()
    ...
    return (
        ...
        "<th><input type='checkbox' aria-label='&#51204;&#52404; &#49440;&#53469;' onclick='toggleAll(this)'></th><th>No</th><th style='text-align:left'>&#44228;&#50557;&#47749;</th><th>&#51648;&#50669;</th><th>&#49464;&#48512;&#51648;&#50669;</th><th>&#44228;&#50557;&#44592;&#44288;</th><th>&#44228;&#50557;&#45824;&#49345;&#51088;</th>"
