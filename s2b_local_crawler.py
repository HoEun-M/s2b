...
{key:'tool',label:'수업도구',keywords:['이음AI','이음 AI','AI 구독','AI구독','Zoom','줌','Vrew','vrew','브루','제미나이','Gemini','클로드','Claude','GPT','지피티','챗지피티','유튜브','YouTube','캔바','Canva','미리캔버스','젭','ZEP','카훗','Kahoot','북크리에이터','패들렛','Padlet','감마','Gamma','수노','Suno','뤼튼','노션','Notion','띵커벨','퀴즈앤','클래스카드','퀴즈렛','다했니','슬라이도','망고보드','투닝','스픽','Speak','일레븐랩스','ElevenLabs','런웨이','Runway','미드저니','Midjourney']},
