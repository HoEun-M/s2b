...
""".strip()
    ...
    return (
        ...
        "</div>"
        "<div class='dashboard-grid'><div class='dash-panel'><h2>&#50629;&#52404;&#48324; &#47588;&#52636;&#50529;</h2><div class='bar-list' id='vendor-chart'></div></div><div class='dash-panel'><h2>&#50900;&#48324; &#47588;&#52636;&#50529;</h2><div class='bar-list' id='month-chart'></div></div><div class='dash-panel'><h2>&#49884;&#46020;&#48324; &#47588;&#52636;&#50529;</h2><div class='bar-list' id='region-chart'></div></div><div class='dash-panel'><div class='dash-head'><h2 id='support-title'>&#49884;&#46020; &#49464;&#48512;&#51648;&#50669;&#48324; &#47588;&#52636;&#50529;</h2><select id='dashboard-region' class='dash-select' onchange='setDashboardRegion(this.value)'></select></div><div class='bar-list' id='support-chart'></div></div><div class='dash-panel'><h2>학교급별 매출액</h2><div class='bar-list' id='school-chart'></div></div><div class='dash-panel'><h2>학교구분별 매출액</h2><div class='bar-list' id='school-type-chart'></div></div><div class='dash-panel'><div class='dash-head'><h2>구매 유형별 계약금액</h2><button type='button' class='purchase-clear' data-purchase-clear='1' onclick='clearPurchaseTypeFilter()'>전체로 보기</button></div><div class='bar-list' id='purchase-type-chart'></div></div></div><div class='purchase-panel'><div class='purchase-head'><h2>구매 유형별 계약금액</h2><div class='purchase-tools'><button type='button' class='purchase-clear' data-purchase-clear='1' onclick='clearPurchaseTypeFilter()'>전체로 보기</button><button type='button' class='purchase-scope active' data-purchase-scope='all' onclick=\"setPurchaseVendorScope('all')\">전체</button><button type='button' class='purchase-scope' data-purchase-scope='mirae' onclick=\"setPurchaseVendorScope('mirae')\">미래엔</button><button type='button' class='purchase-scope' data-purchase-scope='other' onclick=\"setPurchaseVendorScope('other')\">그 외</button><button type='button' class='purchase-csv' onclick='downloadPurchaseCsv()'>CSV 다운로드</button></div></div><div class='purchase-table-wrap'><table class='purchase-table'><thead><tr><th>유형</th><th class='tr'>건수</th><th class='tr'>계약금액 합</th><th class='tr'>비중</th><th class='tr'>건당 평균</th></tr></thead><tbody id='purchase-type-body'></tbody><tfoot id='purchase-type-foot'></tfoot></table></div><div id='purchase-complex-note' class='purchase-note'>복합계약 0건 포함 (단일 제품 기준 아님)</div><div class='purchase-subgrid'><div class='purchase-subpanel'><h3>유형 × 학교급</h3><div class='purchase-table-wrap'><table class='purchase-table'><thead><tr><th>유형</th><th class='tr'>초</th><th class='tr'>중</th><th class='tr'>고</th><th class='tr'>기타</th></tr></thead><tbody id='purchase-level-body'></tbody></table></div></div><div class='purchase-subpanel'><h3>유형 × 월별 추이</h3><div class='purchase-table-wrap'><table class='purchase-table'><thead id='purchase-month-head'></thead><tbody id='purchase-month-body'></tbody></table></div></div></div></div></section>"
